 ...
 */
export const MIN_SILENCE_DURATION_MS = 600;   // ↑ from 400 to 600 ms
 ...
 */
export const SPEECH_PAD_MS     = 100;         // ↑ from 80 to 100 ms
export const SPEECH_PAD_SAMPLES = SPEECH_PAD_MS * INPUT_SAMPLE_RATE_MS;

/**
 * Final speech chunks below this duration are discarded
 */
export const MIN_SPEECH_DURATION_SAMPLES = 
  300 * INPUT_SAMPLE_RATE_MS;                // ↑ from 250 to 300 ms
